The following is a description from the introduction in the  **[document](https://tburnett.github.io/docsrc.JupyDoc)** which was generated by [this code](jupydoc/docsrc/intro.py).

There is also a discussion about **[multi-document support](https://tburnett.github.io/docsrc.MultipleDocs)**.
...
I've used this to fundamentally change my analysis, with a focus on documenting code and results as I generate them. 
